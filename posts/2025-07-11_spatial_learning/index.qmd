...
-  The EPA also has an [EnviroAtlas](https://www.epa.gov/enviroatlas) that has a WHOLE BUNCH of interesting data. From land use/land cover, % forested, % wetland, to wastewater flow discharges, to "area of estimated floodplain classified as land", to business address vacancy rate for 2024 - it's a treasure trove. There's also an [interactive map](https://www.epa.gov/enviroatlas/enviroatlas-interactive-map) if you'd rather just click around than actually download things.  
